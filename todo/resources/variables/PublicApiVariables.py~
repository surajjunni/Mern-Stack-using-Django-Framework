...
SZ_MGMT_IP = "10.1.102.119"
#Must check iPAddress of external auth server for the controller IP mentioned in this file.
W_EXT_URL = "http://10.1.50.10:10001/Sahana/login"
SZ_VERSION = "5.2.0.0.476"
VERSION = "v8_2"
ZONE_NAME = "ios_exe"
DEFAULT_ZONE = "Default Zone"
AP_MACC = ['8C:FE:74:2A:61:70','8C:FE:74:2A:61:70']
AP_IP = "192.168.101.17"
AP2_IP = "192.168.101.17"
AP_IPV6_IP="2001:192:168:10::57"
AP_IPV6_IP2="2001:192:168:10::57"
AP_VERSION= "5.1.2.0.124"
...
TE_IP = "10.174.116.174:1"
TE_USERNAME = "root"
TE_PASSWORD = "ruckus1!"
APPIUM_IP = "10.174.116.126"
APPIUM_UNAME = "iotauto"
APPIUM_PWD = "Password1"
DEFAULT_WLAN_GROUP = "default"
CHANNEL_24 = 1
CHANNEL_50 = 36
MAC_SNIFFER_HOST="50.1.1.14"
MAC_USERNAME="root"
...
#OCTOSCOPE VARIABLES
ATTENUATOR_IP = '10.174.116.50'
MIN_THRESHOLD_LIMIT = 1
MAX_THRESHOLD_LIMIT = 75
STEP_INCR = 5

#FTP SERVER DETAILS
FTP_HOST_NAME = '10.1.50.10'
FTP_USERNAME = 'root'
FTP_PASSWORD = 'iot1!'
FTP_SERVER_PATH = '/srv/ftp'
FTP_PORT_NUMBER = 22
FTP_PROTOCOL = 'SFTP'
...
#Chariot Variables
CHARIOT_IP = "10.174.116.126"
CHARIOT_UNAME = "iotauto"
...
PC_IP = "10.174.116.126"
U_NAME = "iotauto"
PASSWD = "Password1"
EDPSKEY = "87654321"

#If Access Vlan == 1001, sta_network = 100.1
#If Access Vlan == 1003, sta_network = 100.3
sta_network = "100.3"
sta_network_ipv6 = "2000:100:3:3"
#######################################################PREREQUISITES DONE#################################################################
...
HTTP_IP = "http://10.1.50.10:8080"
#HTTP_IP_DATA = "NETGEAR"
HTTP_IP_DATA = "Apache"

#HTTP_URL = "http://11.1.0.1"
#HTTP_DATA = "NETGEAR"
HTTP_URL = "http://10.1.50.10:8080"
HTTP_DATA = "Apache"


HTTP_URL2 = "http://10.1.50.10:8080"
HTTP_DATA2  = "Apache"
...
HTTPS_DATA1 = "Online"
HTTPS_URL1 = "https://www.flipkart.com"
...
HTTPS_URL_ID = "https://www.flipkart.com"
HTTPS_DATA_ID = "Online"
...
FIXED_URL_ID = "http://10.1.50.10:8080"
FIXED_DATA_ID = "Apache"
...
AAA_PWD = "GrE"
'''
AAA_SERVER = "10.1.50.10"
AAA_SECRET = "testing123"
AAA_UNAME = "GrE"
AAA_PWD = "GrE"
...
AAA_NAME = "radiusd"
'''
AAA_PATH = "/etc/freeradius/3.0/mods-config/files"
AAA_NAME = "freeradius"
...
SCG_ADMIN_PASSWORD = "ruckus1!"
SCG_CLI_PROMPT = "SZv"
SCG_ADMIN_ENABLE_PASSWORD = "ruckus1!"
...
GA_LOGO = "test"
GA_TERMS = "test"
GA_REDIRECT_URL = "https://www.flipkart.com/"
...
class Common_var(object):
	...
	device_policy = False
	#access_vlan = 1
        #only ipv4-1001, 1003-dual-Apple Network
        access_vlan = 1003
	client_load = False
	proxy_arp = False
	max_clients = 100
