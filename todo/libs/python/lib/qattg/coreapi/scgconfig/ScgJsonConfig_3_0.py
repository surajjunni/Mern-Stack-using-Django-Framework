...
class ScgJsonConfig():
    ...
    def create_aaa_profile(self, aaa_name="Auto_AAA_Server", zone_name="Auto_APZone", domain_label='Administration Domain', 
                           ...
                           ldap_ip=None, ldap_domainname=None, ldap_search_filter=None, key_attr=None):
    ...
    def reboot_data_plane(self,dp_mac=None):
    ...
    def verify_cluster_is_inservice(self):
        ...
        try:
            ...
            if not recvd_data:
                return None
            if recvd_data["data"]["clusterState"] == "In_Service":
                return True
        except Exception, e:
            print traceback.format_exc()
            return None
