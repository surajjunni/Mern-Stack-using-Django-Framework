...
class ScgJsonConfig():
    def __init__(self, scg_mgmt_ip="127.0.0.2", scg_port="8443"):
        ...
        self.req_api_radius = '/wsg/api/scg/authenticationService/'
        self.req_api_radius_acct = '/wsg/api/scg/accountingService/'
        self.req_api_radius_updt_del='/wsg/api/scg/authenticationService/%s'
        self.req_api_radius_acct_updt_del = '/wsg/api/scg/accountingService/%s'
        self.req_api_ggsn = '/wsg/api/scg/ggsn/'
        self.radius_service_type= 'RADIUS'
        self.req_api_dhcp = '/wsg/api/scg/dhcpserver/'
        self.req_api_dhcp_updt_del = '/wsg/api/scg/dhcpserver/%s'
        self.req_api_cgf = '/wsg/api/scg/accountingService?'
        self.req_api_cgf_updt_del = '/wsg/api/scg/accountingService/%s?'
        ...
        self.req_api_guestpass_updt = '/wsg/api/scg/identity/guestpass?%s'
        ...
        self.req_api_hlr = '/wsg/api/scg/authenticationService'
        self.control_plane_id = '/wsg/api/scg/planes/control/ids?'
        self.map_gateway_settings = '/wsg/api/scg/hlrs/globalsettings?'
        self.req_api_hlr_update ='/wsg/api/scg/authenticationService/%s'
        ...
        self.req_api_zone_template_profile = '/wsg/api/scg/templates2/zone'
        self.req_api_get_zone_template = '/wsg/api/scg/templates2/zone?'
        self.req_api_del_zone_template = '/wsg/api/scg/templates2/zone/%s'
        self.req_api_wispr_zone_template = '/wsg/api/scg/templates2/zone/%s/hotspot'
        self.req_api_apply_zone_template = '/wsg/api/scg/zones/config/applyZoneTemplate/%s'
        ...
        self.req_api_guest_profile_data = '/wsg/api/scg/identity/users?'
        self.req_api_del_idm_profile_data = '/wsg/api/scg/identity/users/%s'
        self.req_api_guest_disable_enable = '/wsg/api/scg/identity/users/false/%s'
        ...
        self.req_api_logout = '/wsg/api/scg/session/currentUser'
        self.req_user_traffic = '/wsg/api/scg/serviceProfiles/userTraffic/?'
        self.req_api_event_notification = '/wsg/api/scg/globalSettings/system/eventNotificationSettings'
        self.req_api_update_nbi_portal_pwd = '/wsg/api/scg/globalSettings/system/nbSettings'
        self.api_add_rule_get = '/wsg/api/scg/devicepolicy/byzone/%s'
        self.api_user_agent_blacklist = '/wsg/api/scg/blacklist/'
        self.api_user_agent_blacklist_updt_del = '/wsg/api/scg/blacklist/%s'
        self.req_api_users_role='/wsg/api/scg/identity/userrole/'
        self.SJT = ScgJsonTemplate()
        self.bridge_url_api = '/wsg/api/scg/serviceProfiles/forwarding'
        self.bridge_url_api_del = '/wsg/api/scg/serviceProfiles/forwarding/%s'
        self.system_summary_url = "/wsg/api/scg/planes/systemSummary"
        self.gateway_advanced_options_api ='/wsg/api/scg/globalSettings/system/gatewayAdvancedOptions'
        self.ntp_server = '/wsg/api/scg/globalSettings/system/systemTime'
        self.arc_app = '/wsg/api/public/v5_1/trafficAnalysis/client/app/topapp'
        self.arc_client = '/wsg/api/public/v5_1/trafficAnalysis/client/app/topclient' 
        
    def apply_zone_template(self, apzone_name="ApZone" , apzone_template_name="ApZoneTemplate"):
        apzone_uuid = self.get_apzone_uuid(apzone_name = apzone_name)
        apzone_template_uuid = self.get_apzone_template_uuid(apzone_template_name = apzone_template_name)
        apply_zone_template = ji.get_url(self.req_api_apply_zone_template%apzone_template_uuid, self.scg_mgmt_ip, self.scg_port)
        user_data = []
        user_data.append([apzone_uuid])
        json_data = json.dumps(user_data)
        result = ji.put_json_data(apply_zone_template, self.jsessionid, json_data)
        return result  
    
    def delete_zone_template(self, apzone_template_name="ApZoneTemplate"):
        apzone_template_uuid = self.get_apzone_template_uuid(apzone_template_name = apzone_template_name)
        delete_zone_template = ji.get_url(self.req_api_del_zone_template%apzone_template_uuid, self.scg_mgmt_ip, self.scg_port)
        result=ji.delete_scg_data(delete_zone_template, self.jsessionid, None)
        return result     
    ...
    def get_key_for_service(self, name='service or profile name', api='/wsg/api/scg/accountingService'):
        """
        API used to key and data of profile
        """
        ...
        for i in range(0, len(data["data"]["list"])):
            if data["data"]["list"][i]["name"] == name:
                ...
                break
        if not key:
            raise Exception("Key not found for name: %s " % (name))
        return key, key_info
        
    def create_user_agent_blacklist(self, group_name="useragent",pattern='Mozilla', error_code='503', errorMessage='user Error'):
        result = False
        blacklist_data={}
        try:
            url = ji.get_url(self.api_user_agent_blacklist, self.scg_mgmt_ip, self.scg_port)
            blacklist_data.update({"groupName":group_name,
                               "pattern": pattern,
                               "error":error_code,
                               "errorMessage":errorMessage,})

            fwd_data = json.dumps(blacklist_data)
    ...
    def _get_key_for_useragent_blacklist_profile(self, url=None, name='useragent'):
        """
        API used to get the key and data of useragent blacklist profile
        
        :param str url: URL
        :param str name: Name of useragent blacklist profile
        :return: key and data of useragent blacklist profile
        ...
        for i in range(0, len(rcv_data["data"]["list"])):
            if rcv_data["data"]["list"][i]["groupName"] == name:
                key, data = rcv_data["data"]["list"][i]["key"], rcv_data["data"]["list"][i]
                break

        if not key:
            raise Exception("_get_key_for_useragent_blacklist_profile():Key not found for the name:%s" % (name))

        return key, data
   
    def delete_user_agent_blacklist(self, blacklist_name="useragent"):
        """ 
        ...
        try:
            url = ji.get_url(self.api_user_agent_blacklist+'getlist/', self.scg_mgmt_ip, self.scg_port)
            key, rcv_radius_data = self._get_key_for_useragent_blacklist_profile(url=url, name=blacklist_name)
            del_black_list_url = ji.get_url(self.api_user_agent_blacklist_updt_del%key, self.scg_mgmt_ip, self.scg_port)
            result = ji.delete_scg_data(del_black_list_url, self.jsessionid, None)
    ...
    def set_gateway_advanced_options(self, nsapi ='5'):

        gateway_profile ={}
        try:
            gateway_profile.update({"allowSessionOnAccountingFail":True,"gtpNetworkServiceAcessPointIdentifier":nsapi,
                    "imeiInGtp":True,"scgRaiInGtpV2":False,"scgSaiInGtpV2":False,"ecgiInGtpV2":True,"taiInGtpV2":True})
            gateway_url = ji.get_url(self.gateway_advanced_options_api,  self.scg_mgmt_ip, self.scg_port)
            json_data = json.dumps(gateway_profile)
            result = ji.put_json_data(gateway_url, self.jsessionid, json_data)
        except Exception, e:
            print traceback.format_exc()
            return False
        return result
    ...
    def create_ggsn(self, domain_name="Auto_Domain_Name.com", ggsn_ip="1.3.5.7", is_mvno_account=False):  
        ...
        try:
            ...
            print traceback.format_exc()
            return False
        self.set_gateway_advanced_options()
        return result
    ...
    def create_bridge_profile(self, bridge_profile_type="Bridge", bridge_profile_name="bridge_profile", bridge_description="create Bridge",
                            bridge_dhcp_realy_enabled=True, bridge_dhcp_server_1="10.1.55.62", bridge_dhcp_server_2="",bridge_dhcp_option_82_enabled=False):
        bridge_profile = {}

        try:
            bridge_profile.update({"key":"","tenantId":"","profileType":bridge_profile_type,"name":bridge_profile_name,
                        "description":bridge_description,"dhcpRelayEnabled":bridge_dhcp_realy_enabled,
                        "dhcpServer1":bridge_dhcp_server_1,"dhcpServer2":bridge_dhcp_server_2,"dhcpOption82Enabled":bridge_dhcp_option_82_enabled})

            bridge_url = ji.get_url(self.bridge_url_api, self.scg_mgmt_ip, self.scg_port)
            json_data = json.dumps(bridge_profile)
            result = ji.post_json_data(bridge_url, self.jsessionid, json_data)
        except Exception, e:
            print traceback.format_exc()
            return False
        return result 

    def delete_bridge_profile(self, bridge_profile_name="bridge_profile"):
        try:
            get_bridge_key_api = self.bridge_url_api + '?type=Bridge'
            key, key_info = self.get_key_for_service(name=bridge_profile_name, api=get_bridge_key_api)

            bridge_url_del = ji.get_url(self.bridge_url_api_del%key, self.scg_mgmt_ip, self.scg_port)
            result = ji.delete_scg_data(bridge_url_del, self.jsessionid, None)
        except Exception, e:
            print traceback.format_exc()
            return False
        return result
    ...
    def create_radius_service(self, service_name="Auto_Radius_Service",
        ...
        URI: POST /wsg/api/scg/authenticationService/
        ...
        result = False
        radius_service={}
        identity_user_role_id = None
    	identity_users_role_url = ji.get_url(self.req_api_users_role, self.scg_mgmt_ip, self.scg_port)
        def_identity_user_role_id = self._get_key_for_profile(name="Default", url=identity_users_role_url)['key']
        try:
            url = ji.get_url(self.req_api_radius, self.scg_mgmt_ip, self.scg_port)
            radius_service.update(self.SJT.get_radius_template_data())
            radius_service.update({"name":service_name,
                                    "description":description,
                                    "radiusIP":primary_ip,
                                    "radiusPort":int(primary_port),
                                    ...
                                    "outOfBandLDForRuckusAP" : int(out_of_bandld),
                                    "radiusShareSecret":primary_share_secret})
            if service_type == "RADIUS":
                radius_service.update({"responseFail":noresponse_fail})
                radius_service.update({"type":self.radius_service_type})
                radius_service.update({"groupAttrs" : [{"groupAttr": "*", "identityUserRoleId": def_identity_user_role_id}]})
            elif service_type == "RADIUSAcct":
                url = ji.get_url(self.req_api_radius_acct, self.scg_mgmt_ip, self.scg_port)
                radius_service.update({"responseFail":"false"})
                radius_service.update({"protocolType": self.radius_service_type})
            ...
            if service_type == "RADIUSAcct" and radius_accounting_support_backup:                                
                ...
                radius_service.update({"secondaryRadiusEnabled":int(radius_support_backup)})
    ...
    def validate_radius_service(self, service_name="Auto_Radius_Service",
        ...
        URI: GET /wsg/api/scg/authenticationService/ 
    ...
    def update_radius_service(self, current_service_name="Auto_Radius_Service", new_service_name=None, service_type="RADIUS", description=None, 
                              ...
                              secondary_ip=None, secondary_port=None, secondary_shared_secret=None,outofband=None,protocol_type=None):
        """ 
        API used to update the RADIUS Service
        
        URI: PUT /wsg/api/scg/authenticationService/<radius_service_key>
        ...
        :param str secondary_port: Secondary Server Port
        :param str secondary_share_secret: Secondary Server Secret
        :param str protocol_type: protocol_type for accounting
        ...
        fwd_radius_data = {}
        try:
            req_api = self.req_api_radius
            req_api_update = self.req_api_radius_updt_del
            if service_type == 'RADIUSAcct':
                req_api = self.req_api_radius_acct
                req_api_update = self.req_api_radius_acct_updt_del
            url = ji.get_url(req_api, self.scg_mgmt_ip, self.scg_port)
            key, rcv_radius_data = self._get_key_for_radius_service(url=url, name=current_service_name)
            print rcv_radius_data
            if service_type == 'RADIUSAcct':
                profile_type = service_type
                fwd_radius_data["protocolType"] = rcv_radius_data["protocolType"] if protocol_type is None else protocol_type
            else:
            ...
            fwd_radius_data["radiusIP"] = rcv_radius_data["radiusIP"]if primary_ip is None else primary_ip 
            fwd_radius_data["radiusShareSecret"] = rcv_radius_data["radiusShareSecret"]if primary_shared_secret is None else primary_shared_secret 
            fwd_radius_data["radiusPort"] = rcv_radius_data["radiusPort"]if primary_port is None else int(primary_port)
            ...
            if profile_type == "RADIUSAcct":
                ...
                if (secondary_ip or secondary_port or secondary_shared_secret):
                    if fwd_radius_data["accountingSupportBackup"] != 1:
                        ...
                        return False
                fwd_radius_data["secondaryRadiusIP"] = rcv_radius_data["secondaryRadiusIP"] if secondary_ip is None else secondary_ip
                fwd_radius_data["secondaryRadiusPort"] = rcv_radius_data["secondaryRadiusPort"] if secondary_port is None else int(secondary_port)
                fwd_radius_data["secondaryRadiusShareSecret"] = \
                    rcv_radius_data["secondaryRadiusShareSecret"] if secondary_shared_secret is None else secondary_shared_secret
                fwd_radius_data["outOfBandLDForRuckusAP"] = rcv_radius_data["outOfBandLDForRuckusAP"] if outofband is None else int(outofband)
                fwd_radius_data["accountAutoFallBack"] =   rcv_radius_data["accountAutoFallBack"]

            elif profile_type == "RADIUS":
                fwd_radius_data["secondaryRadiusEnabled"] = rcv_radius_data["secondaryRadiusEnabled"] if radius_support_backup is None else int(radius_support_backup)
                if (secondary_ip or secondary_port or secondary_shared_secret):
                    if fwd_radius_data["secondaryRadiusEnabled"] != 1:
                        print "invalid input: radius support backup"
                        return False
                if int(fwd_radius_data["secondaryRadiusEnabled"]) == 1:
            ...
            url_radius_update = ji.get_url(req_api_update%key, self.scg_mgmt_ip, self.scg_port)
    ...
    def delete_radius_service(self, radius_service_name="Auto_Radius_Service",service_type="RADIUS",):
        """ 
        API used to delete the Radius Service

        URI: DELETE /wsg/api/scg/authenticationService/<radius_service_key>
        ...
        try:
            ...
            if service_type=="RADIUSAcct":
	            ...
	            del_radius_url = ji.get_url( self.req_api_radius_acct_updt_del%key , self.scg_mgmt_ip, self.scg_port)
    ...
    def get_apzone_template_uuid(self, apzone_template_name='APZone-1'):
        """
        API used to find the zoneUUID of given= APZoneTemplate
        
        URI: GET /wsg/api/scg/zones/config/applyZoneTemplate/<domainUUID>

        :param str apzone_template_name: Name of the APZone Template
        :return: zoneUUID
        :rtype: unicode
        ...
        is_entry_found = False
        zone_template_uuid = None
        url = ji.get_url(self.req_api_get_zone_template, self.scg_mgmt_ip, self.scg_port)
        rcvd_data = ji.get_json_data(url, self.jsessionid)


        if len(rcvd_data['data']['list']) >= 1:
            for data in rcvd_data['data']['list']:
                if data['name'] == apzone_template_name:
                    zone_template_uuid = data['key']
                    is_entry_found = True
                    break
        else:
            raise Exception("get_apzone_template_uuid(): No data.list recvd")

        if not is_entry_found:
            raise Exception("get_apzone_template_uuid(): apzone: %s not found" % apzone_template_name)
        
        return zone_template_uuid
    ...
    def create_aaa_profile(self, aaa_name="Auto_AAA_Server", zone_name="Auto_APZone", domain_label='Administration Domain', 
                           ...
                           ad_ip=None, global_catalog_ad=None, windows_domainname=None,
                           admin_domainname=None, admin_pw=None,
                           ldap_ip=None, ldap_port=389, ldap_domainname=None, ldap_search_filter=None, key_attr=None):
	    ...
	    url = ji.get_url(self.req_api_aaa, self.scg_mgmt_ip, self.scg_port)
            ...
            if radius_type == "RADIUS":
                ...
                aaa_profile.update({"responseFail": False,
                                    "radiusIP":ad_ip,
                                    "radiusPort": 389,
                                    "globalCatalog": global_catalog_ad,
                                    "ip":ad_ip,
                                    "port": 389 })
                if windows_domainname:
                    aaa_profile.update({"windowsDomainName":windows_domainname})
                if global_catalog_ad:
                    aaa_profile.update({"radiusPort":3268,
                                        "adminDomainName":admin_domainname,
                                        "password":admin_pw,
                                        "port":3268})
            elif radius_type == "LDAP":
                aaa_profile.update({"radiusIP":ldap_ip,
                                    "radiusPort":ldap_port,
    ...
    def get_type_for_aaa_profile(self, zone_name=None, name=None, domain_label='Administration Domain'):
        api = self.req_api_aaa_data + self.get_apzone_uuid(apzone_name=zone_name, domain_label=domain_label) + "?"
        url = ji.get_url(api, self.scg_mgmt_ip, self.scg_port)
        key,data = self._get_key_for_aaa_profile(url=url,name=name)
        return data["type"]
    ...
    def create_wispr_profile(self, wispr_profile_name="Auto_wispr_profile", zone_name="Auto_APZone", domain_label="Administration Domain",
        ...
        try:
            ...
            if walled_garden:
                wispr_profile.update({"walledGarden":walled_garden})
            if location_id:
    ...
    def _get_key_for_guest_pass(self, name=None):
        ...
        url_str = "criteria=&page=1&start=0&limit=20"
        profile_data_url = ji.get_url(self.req_api_guestpass_updt + url_str, self.scg_mgmt_ip, self.scg_port)
        ...
        for i in range(0, len(rcvd_data['data']['list'])):
            if rcvd_data['data']['list'][i]['displayName'] == name:
                key, data = rcvd_data['data']['list'][i]['userKey'], rcvd_data['data']['list'][i]
                break
        if not key:
    ...
    def create_cgf_service(self, cgf_service_name="CGF", description=None,
        ...
        URI: POST /wsg/api/scg/accountingService?
    ...
    def validate_cgf_service(self,cgf_service_name="CGF", description=None,
        ...
        URI: GET /wsg/api/scg/accountingService?
    ...
    def update_cgf_service(self, current_cgf_service_name="CGF", new_cgf_service_name=None,description=None,
        ...
        URI: PUT /wsg/api/scg/accountingService?
    ...
    def delete_cgf_service(self, cgf_service_name="TEST"):
        ...
        URI: DELETE /wsg/api/scg/accountingService/<cgf_service_keys> 
    ...
    def add_server_ip_to_cgf_service(self,cgf_service_name="CGF", 
        ...
        URI: PUT /wsg/api/scg/accountingService/<cgf_service_key>
    ...
    def create_ftp_service(self, ftp_name="BORA", ftp_host="1.2.3.4",
                                 ftp_port="22", ftp_username="ruckus", ftp_password="ruckus1!", remote_dir="", ftp_protocol="FTP"):
        """
    ...
    def create_hlr_service(self, hlr_name="Auto_HLR_Service", 
        ...
        try:
 	       ...
 	       if hlr_data["data"]["list"][i].has_key("routingContext"):
            ...
            hlr_profile.update({"name":hlr_name, "description":description,
                ...
                #"sgsnIsdnAddress":sgsn_isdn_address, "routingContext":routing_context,"pointCode": "2",
            ...
            #hlr_profile.update({"groupAttrs" : [{"groupAttr": "*", "identityUserRoleId": def_identity_user_role_id}]})
    ...
    def _validate_sctp_list(self, sctp_passed_data=None, hlr_name=None, sctp_destination_ip=None, sctp_destination_port=None, 
        ...
        URL: GET  /wsg/api/scg/authenticationService/
    ...
    def add_sctp_association_to_hlr(self, hlr_name="Auto_HLR_Service", sctp_destination_ip="1.2.3.4",
        ...
        URI: PUT /wsg/api/scg/authenticationService/<HLR_service_key>
    ...
    def delete_hlr_service(self, hlr_name="Auto_HLR_Service"):
        ...
        URI: DELETE /wsg/api/scg/authenticationService/
    ...
    def _get_acct_details(self, name="Auto_Radius_Service"):

        service_det = None
        url = ji.get_url(self.req_api_acct_service, self.scg_mgmt_ip, self.scg_port)
        data = ji.get_json_data(url,self.jsessionid)
        print data[u"data"][u"list"]
        for i in range(0,len(data[u"data"][u"list"])): 
            if data[u"data"][u"list"][i][u"serviceName"] == name:
                service_det = data[u"data"][u"list"][i]
                break

        if not service_det:
            raise Exception("_get_acct_details(): Key not found for the name :%s" % (name))
    ...
    def create_apzone(self, zone_name="Auto_APZone", domain_label='Administration Domain',
                            description=None, 
                            ap_firmware=None,
                            country_code=os.getenv("COUNTRY_CODE", "IN"), login_id="admin", password="testing123", 
                            location="",location_additional_info="",
                            ...
                            radio_2Ghz_channel=os.getenv("WLAN_CHANNEL", '0'),                       #0(Auto) to 11
                            radio_2Ghz_tx_power="max",                  #full="max" and -1 to -10 ,"min"
                            radio_5Ghz_channelization="40MHz",          #20MHz or 40MHz
                            radio_5Ghz_channel_indoor=os.getenv("WLAN_CHANNEL_5G_INDOOR", '0'),      #0,36,40,44,48,149,153,157,161
                            radio_5Ghz_channel_outdoor=os.getenv("WLAN_CHANNEL_5G_OUTDOOR", '0'),               # 149,153,157,161
                            ...
                            back_ground_scan_on_2GHz='1',                 #1 or 0
                            back_ground_scan_on_2GHz_timer='20',           #1 to 65535
                            back_ground_scan_on_5GHz='1',                 #1 or 0
	...
	:param str latitide: this is gps cordinate 12.345
	:param str lationgitude: this is gps cordinate 12.34
        ...
        try:
            ...
            zone_profile["commonConfig"].update({"_allowIndoorChannel":int(channel_mode), "apLogin":login_id, "apPass":password, 
                                               "location":location, "locationAdditionalInfo":location_additional_info,
            ...
            if latitude and longitude:
                zone_profile.update({"gpsInfo":"%s,%s"%(latitude,longitude)})
    ...
    def create_apzone_template(self, zone_name="Auto_APZone_template", domain_label='Administration Domain',
                            description=None, 
                            ap_firmware=None,
                            country_code=os.getenv("COUNTRY_CODE", "IN"), login_id="admin", password="testing123", 
                            syslog_ip="", syslog_port='514', 
                            ...
                            radio_5Ghz_channel_outdoor=os.getenv("WLAN_CHANNEL_5G_OUTDOOR", '0'),               # 149,153,157,161
                            radio_5Ghz_tx_power="max",                  #full="max" and -1 to -10 ,"min"
                            tunnel_type='0',                              #GRE+UDP:1, RuckusGRE:0
                            enable_tunnel_encryption='0',                 #0 or 1
                            wan_interface_mtu='1',                       #tunnel MTU enable:auto(1) or manual (0)
                            mtu_size='1500',                              #in bytes from 850 to 1500
                            channel_mode='0',                             #allow_indoor_channels:1 or 0
...
wsg/api/scg/templates2/zone
    ...
    :param str lationgitude: this is gps cordinate 12.34
        ...
        zone_profile["meshConfig"] = {}
        try:
            url = ji.get_url(self.req_api_zone_template_profile, self.scg_mgmt_ip, self.scg_port)
            zone_profile.update(self.SJT.zone_data())
            zone_profile.update(self.SJT.get_zone_data_update())
            if not ap_firmware:
                url_firmware = ji.get_url(self.req_api_firmware, self.scg_mgmt_ip, self.scg_port)
                firmware_data = ji.get_json_data(url_firmware, self.jsessionid)
                len_firware_list = len(firmware_data['data']['list'])
    ...
    def validate_apzone(self, zone_name="Auto_APZone", domain_label='Administration Domain', description=None, ap_firmware=None,
        ...
        try:
            ...
            gps_info = "%s,%s"%(latitude,longitude)
            gps = latitude and longitude
            
            if gps:
                if gps_info != str(rcvd_data["gpsInfo"]):
                    self._print_err_validate('validate_apzone', 'gps_info', 'gpsInfo', gps_info,
                            rcvd_data["gpsInfo"])
                    return False
    ...
    def update_apzone(self, current_zone_name="Auto_APZone", new_zone_name=None, domain_label='Administration Domain', description=None,
                      ...
                      password=None, location=None, location_additional_info=None, syslog_ip=None, syslog_port=None,
        ...
        try:
            ...
            if gps:
                fwd_zone_data["gpsInfo"] = zone_profile["gpsInfo"] 
                
            fwd_zone_data["location"] = zone_profile["commonConfig"]["location"] if location is None else location
            fwd_zone_data["locationAdditionalInfo"] = zone_profile["commonConfig"]["locationAdditionalInfo"] if location_additional_info is None else location_additional_info
    
            fwd_zone_data["commonConfig"]["location"] = zone_profile["commonConfig"]["location"] if location is None else location
            fwd_zone_data["commonConfig"]["locationAdditionalInfo"] = zone_profile["commonConfig"]["locationAdditionalInfo"] if location_additional_info is None else location_additional_info
    ...
    def create_wlan(self,
            ...
            enable_ofdm_only='0',
            bss_min_rate="0",
            usertrfc_name="System Default",
            mgmt_tx_rate="2mbps",
            web_auth_name='',
            zero_it_enables= False,
            dpsk_Enabled=False,
            enable_Band_Balancing_Shield= False,
            pmk_enable="0",
            okc_enable="0",
            operator_realm=None):
        """ 
        ...
        :param str operator_realm: relam of operator to be specified
        ...
        try:
            ...
            usertraffic_url = ji.get_url(self.req_user_traffic, self.scg_mgmt_ip, self.scg_port)
            usertraffic_key = self._get_key_for_profile(name=usertrfc_name, url=usertraffic_url)['key']
            ...
            wlan_profile.update({"mobilityZoneUUID":self.get_apzone_uuid(apzone_name=apzone_name, domain_label=domain_label), "zoneName":apzone_name,
             "zeroItEnabled": zero_it_enables,"dpskEnabled": dpsk_Enabled,"enableBandBalancingShield": enable_Band_Balancing_Shield})
            wlan_profile["configContent"].update({"Name":wlan_name, "SSID":ssid,"Description":description,
                                                            ...
                                                            "_userTrafficProfileId":usertraffic_key,
												            "PMKEnable": int(pmk_enable),
												            "OKCEnable": int(okc_enable),                                    
                                                            })
            ...
            if device_policy and device_policy == 'Disable':
                wlan_profile["configContent"].update({"_devicePolicyId":""})
            elif device_policy:
                dp_key, dp_data = self.get_key_and_data_for_device_policy(name=device_policy, apzone_name=apzone_name, domain_label=domain_label)
                wlan_profile["configContent"].update({"_devicePolicyId":dp_key})

            if int(enable_tunnel) == 1:
                #wlan_profile["configContent"]["ForceClientDhcpEnable"] = 1
                wlan_profile["configContent"]["STAIssolation"] = 1
                ...
                if core_network_type == "TTGPDG":
                    ...
                    if operator_realm:
                        wlan_profile["configContent"].update({"OperatorRealm":operator_realm})
            ...
            if int(authentication_type) == 0:
                ...
                if authentication_method == "802.1X" and int(enable_tunnel) == 0:

                    wlan_profile["configContent"].update({"authSCGProxy":int(enable_scg_proxy_for_auth)})
                    wlan_profile["configContent"].update({"acctSCGProxy":int(enable_scg_proxy_for_acct)})
                    if enable_scg_proxy_for_auth and int(enable_scg_proxy_for_auth) == 1:
                        wlan_profile["configContent"].update({"authServiceId":self._get_key_for_profile(name=auth_profile_name, url=auth_url)['key']})
                    elif enable_scg_proxy_for_auth and int(enable_scg_proxy_for_auth) == 0:
                        wlan_profile["configContent"].update({"_AAAId":self._get_key_for_profile(name=auth_profile_name, url=aaa_url)['key']})
                    if enable_scg_proxy_for_acct and int(enable_scg_proxy_for_acct) == 0:
                        if acct_profile_name == "Disable":
                            wlan_profile["configContent"].update({"_AcctId":""})
            ...
            elif authentication_type and int(authentication_type) == 5:
                #wlan_profile["configContent"]["ForceClientDhcpEnable"] = 1
                wlan_profile["configContent"]["STAIssolation"] = 1
                if authentication_method != "802.1X" and encryption_method != "NONE":
                    wlan_profile["configContent"].update({"WPAPassphrase":passphrase})
                ...
                wlan_profile["configContent"].update({"_WLANType":int(authentication_type)})
                webauth_key, web_auth_data = self._get_webauth_data_and_key(web_auth_name=web_auth_name,
                                                                            apzone_name=apzone_name,
                                                                            domain_label=domain_label)
                wlan_profile.update({"webAuthenticationId":webauth_key})
                wlan_profile["configContent"].update({"authSCGProxy":int(enable_scg_proxy_for_auth)})
                wlan_profile["configContent"].update({"acctSCGProxy":int(enable_scg_proxy_for_acct)})

                if enable_scg_proxy_for_auth and (int(enable_scg_proxy_for_auth) == 0):
                    wlan_profile["configContent"].update({"webauthAuthServiceId":self._get_key_for_profile(name=auth_profile_name, url=aaa_url)['key']})
                    wlan_profile["configContent"].update({"_AAAId":self._get_key_for_profile(name=auth_profile_name, url=aaa_url)['key']})

                elif enable_scg_proxy_for_auth and (int(enable_scg_proxy_for_auth) == 1):
                    wlan_profile["configContent"].update({"webauthAuthRADIUSId":self._get_key_for_profile(name=auth_profile_name, url=radius_uri)['key']})
                    wlan_profile["configContent"].update({"authServiceId": self._get_key_for_profile(name=auth_profile_name, url=radius_uri)['key']})
                ...
                if enable_scg_proxy_for_acct and (int(enable_scg_proxy_for_acct) == 0):
                    ...
                    if acct_profile_name == 'Disable':
                        ...
                        wlan_profile["configContent"].update({"acctRADIUSId":self._get_key_for_profile(name=acct_profile_name, url=radius_acct_uri)['key']})
                        wlan_profile["configContent"].update({"acctServiceId":self._get_key_for_profile(name=acct_profile_name, url=radius_acct_uri)['key']})
                        wlan_profile["configContent"].update({"_AcctInterval":int(acct_interim_time)})
                
            if wlan_profile["configContent"]["Authentication"] != "OPEN":
                wlan_profile["configContent"].update({"DVlanEnabled":int(dynamic_vlan_enable)})

            if int(authentication_type) == 0 or int(authentication_type) == 3 or int(authentication_type) == 4:
                if enable_scg_proxy_for_auth and (int(enable_scg_proxy_for_auth) == 1):
                    if int(authentication_type) == 0: 
                        if authentication_method != "OPEN":
                            wlan_profile["configContent"].update({"RFC5580SupportEnabled":int(enable_rfc5580)})
                            wlan_profile["configContent"].update({"OperatorRealm":operator_realm})
                    else:
                        wlan_profile["configContent"].update({"RFC5580SupportEnabled":int(enable_rfc5580)})
                        wlan_profile["configContent"].update({"OperatorRealm":operator_realm})
    ...
    def update_wlan(self, current_wlan_name="Auto_WLAN_Profile",
        ...
        :param str operator_realm: realm specified by operator
        :return: True if Validate WLAN successfull else False
        :rtype: boolean
        ...
        try:
            ...
            fwd_wlan_data["name"] = wlan_profile["name"]
            ...
            fwd_wlan_data["configContent"]["OKCEnable"] = \
                wlan_profile["configContent"]["OKCEnable"] if okc_enable is None else int(okc_enable)

            fwd_wlan_data["configContent"]["PMKEnable"] = \
                wlan_profile["configContent"]["PMKEnable"] if pmk_enable is None else int(pmk_enable)
            ...
            fwd_wlan_data["configContent"]["ForceClientDhcpEnable"] = \
                wlan_profile["configContent"]["ForceClientDhcpEnable"] if force_dhcp is None else int(force_dhcp)
            ...
            if wlan_profile["configContent"]["_WLANType"] == 0 or wlan_profile["configContent"]["_WLANType"] == 3 or wlan_profile["configContent"]["_WLANType"] == 4:
                if wlan_profile["configContent"]["authSCGProxy"] == 1 or enable_scg_proxy_for_auth == 1:
                    if wlan_profile["configContent"]["Authentication"] != "OPEN":
                        fwd_wlan_data["configContent"].update({"RFC5580SupportEnabled":int(enable_rfc5580)})
                        if int(enable_rfc5580) == 1:
                            fwd_wlan_data["configContent"].update({"OperatorRealm":operator_realm})
            ...
            fwd_wlan_data["configContent"]["_userTrafficProfileId"] = wlan_profile["configContent"]["_userTrafficProfileId"] if not usertrfc_name else self._get_key_for_profile(name=usertrfc_name, url=usertraffic_url)['key']
            ...
            if fwd_wlan_data["configContent"]["TunnelEnabled"] == 1:
                ...
                if fwd_wlan_data["configContent"]["coreNetworkType"] == "TTGPDG":
                ...
                elif fwd_wlan_data["configContent"]["coreNetworkType"] == "PMIPv6":
                    ...
                    fwd_wlan_data["configContent"]["OperatorRealm"] = wlan_profile["configContent"]["OperatorRealm"] if not \
                        operator_realm else operator_realm
                    if no_operator_realm:
                        fwd_wlan_data["configContent"]["OperatorRealm"] = ""
            ...
            if fwd_wlan_data["configContent"]["_WLANType"] == 0:
                ...
                fwd_wlan_data["configContent"]["authSCGProxy"] = 1
                fwd_wlan_data.update({"guestAccessId":self._get_guest_access_id(apzone_name=apzone_name,
                                                                                                domain_label=domain_label,
                                                                                                guest_access_name=guest_access_name)})
                if not auth_profile_name:
                    fwd_wlan_data["configContent"]["authServiceId"] = wlan_profile["configContent"]["authServiceId"]
                elif auth_profile_name == "Guest":
                    fwd_wlan_data["configContent"]["authServiceId"] = "11111111-1111-1111-1111-111111111111"
                elif auth_profile_name == "Always Accept":
                    fwd_wlan_data["configContent"]["authServiceId"] = "22222222-2222-2222-2222-222222222222"
                else:
                ...
                if not acct_profile_name:
                    fwd_wlan_data["configContent"]["acctServiceId"] = wlan_profile["configContent"]["acctServiceId"]
                elif auth_profile_name == "Guest":
                    fwd_wlan_data["configContent"]["acctServiceId"] = "11111111-1111-1111-1111-111111111111"
                elif auth_profile_name == "Always Accept":
                    fwd_wlan_data["configContent"]["acctServiceId"] = "22222222-2222-2222-2222-222222222222"
                else:
                    print " %s is Not a valid Accounting Service name" % (auth_profile_name)
                    return False

            elif fwd_wlan_data["configContent"]["_WLANType"] == 5:
                fwd_wlan_data["configContent"]["_HotspotId"] = wlan_profile["configContent"]["_HotspotId"] \
                        if wispr_hotspot_name is None else self._get_key_for_profile(wispr_hotspot_name, wispr_url)['key']
               ...
               #                                                             apzone_name=apzone_name,
               #                                                             domain_label=domain_label)
                fwd_wlan_data["webAuthenticationId"] = wlan_profile["webAuthenticationId"]
                
                fwd_wlan_data["configContent"]["authSCGProxy"] = wlan_profile["configContent"]["authSCGProxy"]
                fwd_wlan_data["configContent"]["acctSCGProxy"] = wlan_profile["configContent"]["acctSCGProxy"]

                if (int(fwd_wlan_data["configContent"]["authSCGProxy"]) == 0):
                    fwd_wlan_data["configContent"].update({"webauthAuthServiceId":self._get_key_for_profile(name=auth_profile_name, url=aaa_url)['key']})
                    fwd_wlan_data["configContent"].update({"_AAAId":self._get_key_for_profile(name=auth_profile_name, url=aaa_url)['key']})

                elif  (int(fwd_wlan_data["configContent"]["authSCGProxy"]) == 1):
                    fwd_wlan_data["configContent"].update({"webauthAuthRADIUSId":self._get_key_for_profile(name=auth_profile_name, url=radius_uri)['key']})
                    fwd_wlan_data["configContent"].update({"authServiceId": self._get_key_for_profile(name=auth_profile_name, url=radius_uri)['key']})

                if (int(fwd_wlan_data["configContent"]["acctSCGProxy"]) == 0):
                    if acct_profile_name == 'Disable':
                        fwd_wlan_data["configContent"].update({"_AcctId":""})
                    else:
                        fwd_wlan_data["configContent"].update({"_AcctId":self._get_key_for_profile(name=acct_profile_name, url=aaa_url)['key']})
                        fwd_wlan_data["configContent"].update({"_AcctInterval":int(acct_interval)})

                elif (int(fwd_wlan_data["configContent"]["acctSCGProxy"]) == 1):
                    if acct_profile_name == 'Disable':
                        fwd_wlan_data["configContent"].update({"acctRADIUSId":""})
                        fwd_wlan_data["configContent"].update({"acctServiceId":""})

                    else:
                        fwd_wlan_data["configContent"].update({"acctRADIUSId":self._get_key_for_profile(name=acct_profile_name, url=radius_acct_uri)['key']})
                        fwd_wlan_data["configContent"].update({"acctServiceId":self._get_key_for_profile(name=acct_profile_name, url=radius_acct_uri)['key']})
                        fwd_wlan_data["configContent"].update({"_AcctInterval":int(acct_interval)})
    ...
    def create_profile_in_identity(self, first_name='FirstName', last_name='LastName',
                             ...
                             state='ENABLED', comment=None,
                             login_name='admin1', login_password='ruckus1!',
                             package_name='Local User Package'):
    ...
    def _get_profile_data_in_identity(self, login_name="profile_username"):
        ...
        profile_data_url = ji.get_url(self.req_api_guest_profile_data + url_str, self.scg_mgmt_ip, self.scg_port)
    ...
    def _get_guest_user_data_identity(self, guest_name="nms123"):
        ...
        for i in range (0, len(rcvd_data['data']['list'])):
            if rcvd_data['data']['list'][i]['displayName'] == guest_name:
                key, data = rcvd_data['data']['list'][i]['userKey'], rcvd_data['data']['list'][i]
                break

        if not key:
            raise Exception("_get_guest_user_data_identity(): Guest Entry not found for name %s" % (guest_name))

        return key, data

    def enable_disable_guest_user(self,isEnable=True, guest_name="nms123"): 
        key, data = None, None
        key, data = self._get_guest_user_data_identity(guest_name=guest_name)
        guest_enable_disable_url = ji.get_url(self.req_api_guest_disable_enable%key , self.scg_mgmt_ip, self.scg_port)
        fwd_radius_data = {}
        fwd_radius_data["userName"]=guest_name
        fwd_radius_data["displayName"]=guest_name
        fwd_radius_data["uniqueId"]=key
        if isEnable:
            fwd_radius_data["userStatus"]="ENABLED"
        else:
            fwd_radius_data["userStatus"]="DISABLED"    
        json_data = json.dumps(fwd_radius_data)
        result = ji.put_json_data(guest_enable_disable_url, self.jsessionid, json_data)

        return result
    
    def validate_guest_user_data_identity(self, guest_name=None, loginPassword=None, wlanName=None, zoneName=None,  \
                                          maxDevices=None, expirationUnit=None, expirationValue=None, expireAfterIfNotUsed=None, expirationDate=None,\
                                          sessionUnit=None, sessionValue=None, autoGeneratePassword=None, guestExpiration=None):
        """
        API used to validate Profile in Identity

        :param str guest_name: First Name
        :param str loginPassword: Last Name
        :param str wlanName: Email Address
        :param str zoneName: Phone Number
        :return: True if validate guest user data in Identity Success else False
        :rtype: boolean
        """

        try:
            key, data = self._get_guest_user_data_identity(guest_name=guest_name)
            if loginPassword and loginPassword != data['loginPassword']:
                self._print_err_validate('validate_guest_user_data_identity', 'loginPassword', 'loginPassword',
                        loginPassword, data['loginPassword'])
                return False

            if wlanName != data['wlanName']:
                self._print_err_validate('validate_guest_user_data_identity', 'wlanName', 'wlanName',
                        wlanName, data['wlanName'])
                return False
            
            if zoneName != data['zoneName']:
                self._print_err_validate('validate_guest_user_data_identity', 'zoneName', 'zoneName',
                        zoneName, data['zoneName'])
                return False                 
            
            if maxDevices and maxDevices != data['maxDevices']:
                self._print_err_validate('validate_guest_user_data_identity', 'maxDevices', 'maxDevices',
                        maxDevices, data['maxDevices'])
                return False  
           
            if expirationUnit and expirationUnit != data['expirationUnit']:
                self._print_err_validate('validate_guest_user_data_identity', 'expirationUnit', 'expirationUnit',
                        expirationUnit, data['expirationUnit'])
                return False  
            
            if expirationValue and expirationValue != data['expirationValue']:
                self._print_err_validate('validate_guest_user_data_identity', 'expirationValue', 'expirationValue',
                        expirationValue, data['expirationValue'])
                return False  
            
            if expireAfterIfNotUsed and expireAfterIfNotUsed  != data['expireAfterIfNotUsed']:
                self._print_err_validate('validate_guest_user_data_identity', 'expireAfterIfNotUsed', 'expireAfterIfNotUsed',
                        expireAfterIfNotUsed, data['expireAfterIfNotUsed'])
                return False  
            
            if expireAfterIfNotUsed and expirationDate != data['expirationDate']:
                self._print_err_validate('validate_guest_user_data_identity', 'expirationDate', 'expirationDate',
                        expirationDate, data['expirationDate'])
                return False
            
            if expireAfterIfNotUsed and guestExpiration != data['guestExpiration']:
                self._print_err_validate('validate_guest_user_data_identity', 'guestExpiration', 'guestExpiration',
                        guestExpiration, data['guestExpiration'])
                return False
        
            if sessionUnit and sessionUnit  != data['sessionUnit']:
                self._print_err_validate('validate_guest_user_data_identity', 'sessionUnit', 'sessionUnit',
                        sessionUnit, data['sessionUnit'])
                return False  
            
            if sessionValue and sessionValue  != data['sessionValue']:
                self._print_err_validate('validate_guest_user_data_identity', 'sessionValue', 'sessionValue',
                        sessionValue, data['sessionValue'])
                return False  
            
            if autoGeneratePassword and autoGeneratePassword  != data['autoGeneratePassword']:
                self._print_err_validate('validate_guest_user_data_identity', 'autoGeneratePassword', 'autoGeneratePassword',
    ...
    def delete_profile_in_identity(self, login_name="profile_username"):
        ...
        URI: DELETE /wsg/api/scg/identity/users/<profile_key>/<username>? 
        ...
        try:
            key, data = self._get_profile_data_in_identity(login_name=login_name)
            del_url = ji.get_url(self.req_api_del_idm_profile_data%(key), self.scg_mgmt_ip, self.scg_port)
            result = ji.delete_scg_data(del_url, self.jsessionid, None)
    ...
    def create_guest_pass(self, login_name='Auto_guest',
                                    ...
                                    loginPassword="",
                                    passUseDays='7',
                                    timeIntervalReloginDuration='DAY',
                                    reLoginTime='1',):
        """
        ...
        try:
            ...
            if max_device_limit == 'true':
                fwd_data.update({"maxAllowedDeviceLimitNum":int(max_allowed_device)})
            if not auto_gen_password:
                fwd_data.update({"loginPassword":loginPassword})
            if pass_effect_since:
                fwd_data.update({"passUseDays":passUseDays})
            if  req_guest_relogin:
                fwd_data.update({"reLoginTime":reLoginTime})
                fwd_data.update({"timeIntervalReloginDuration":timeIntervalReloginDuration})
            json_data = json.dumps(fwd_data)
            result = ji.put_json_data(url, self.jsessionid, json_data)
        except Exception, e:
            print traceback.format_exc()
    ...
    def create_guest_access(self, apzone_name='Auto_APZone', domain_label='Administration Domain',
                                ...
                                start_page='user', start_url="", sms_gateway_id="",
                                tc_enabled=False, terms_and_condtn="",
                                title="", session_time='1440', grace_period='60',
                                logo_file=""):
        result = False
        guest_data={}
        try:
    ...
    def logout(self):
        ...
        try:
            ...
            result = ji.delete_scg_data(logout_url, self.jsessionid, None)
    ...
    def config_nbi_portal_password(self,nbi_password):
        result = False
        nbi_data={}
        try:
            url = ji.get_url(self.req_api_update_nbi_portal_pwd, self.scg_mgmt_ip, self.scg_port)
            nbi_data.update({"nbPasswd":nbi_password})
            fwd_data = json.dumps(nbi_data)
            result = ji.put_json_data(url, self.jsessionid, fwd_data)
        except Exception, e:
            print traceback.format_exc()
            return False
    ...
    def configure_event_notification(self,event_code=None,db_persistence=None,trigger_trap=None,trigger_email=None):

        result = False
        event_data = {}
        is_entry_found = False
        if not event_code:
            print "configure_event_notification(): event code required"
            return result
        if not db_persistence and not trigger_trap and not trigger_email:
            print "configure_event_notification(): State required"
            return result
        try:
            url = ji.get_url(self.req_api_event_notification, self.scg_mgmt_ip, self.scg_port)
            recvd_data = ji.get_json_data(url, self.jsessionid)

            recvd_event_data = copy.deepcopy(recvd_data['data']['list'])

            for event in recvd_event_data:
                if str(event['eventCode']) == event_code:
                    event_data['eventCode'] = event['eventCode']
                    event_data['dbPersistence'] = db_persistence if db_persistence else event['dbPersistence']
                    event_data['triggerTrap'] =  trigger_trap if trigger_trap else event['triggerTrap']
                    event_data['triggerEmail'] = trigger_email if trigger_email else event['triggerEmail']
                    is_entry_found = True
                    break
            if not is_entry_found:
                print "configure_event_notification(): event (code %s) does not exist" %event_code
                return False
            else:
    ...
    def get_map_gateway_settings_in_hlr_service(self):
        map_gateway_settings="/wsg/api/scg/hlrs/globalsettings?"
        try:
            url = ji.get_url(map_gateway_settings, self.scg_mgmt_ip, self.scg_port)
            rcv_data = ji.get_json_data(url, self.jsessionid)
    ...
    def change_map_gateway_settings_in_hlr(self,active_map_gateway=None):
        result = False
        try:
            data = self.get_map_gateway_settings_in_hlr_service()
            sjc = ScgJsonConfig(scg_mgmt_ip=self.scg_mgmt_ip, scg_port=self.scg_port)
            sjc.set_jsessionid(self.jsessionid)
            traffic_mode = "Load_Share"
            if data["mapGatewayEnabled"] == False:
                res = sjc.update_map_gateway_settings_in_hlr_service(enable_map_gateway_service=True,traffic_mode=traffic_mode,active_map_gateway=active_map_gateway)
                if res:
                    data = self.get_map_gateway_settings_in_hlr_service()
                time.sleep(60)

            if data["trafficMode"] == "Load_Share":
                traffic_mode = "Override"
            print "Traffic mode is changing from %s to %s" %(data["trafficMode"],traffic_mode)
            result = sjc.update_map_gateway_settings_in_hlr_service(enable_map_gateway_service=True,traffic_mode=traffic_mode,active_map_gateway=active_map_gateway)
        except Exception, e:
            print traceback.format_exc()
            return False
        return result

    def reboot_ap_by_macaddress(self,ap_mac=None):

        recvd_data = None
        ap_data = None

        self.json_url = "/wsg/api/scg/aps/"+ap_mac+"/reboot"
        self.ap_url = "/wsg/api/scg/aps/"+ap_mac
        if ap_mac is None:
            print "ap_mac is None"
            return ap_mac
        ...
        try:
            ...
            if not recvd_data:
                return None
            while True:
                url = ji.get_url(self.ap_url, self.scg_mgmt_ip, self.scg_port)
                ap_data = ji.get_json_data(url, self.jsessionid)
                if ap_data:
                    if ap_data["data"]["connectionStatus"] == "Connect":
                         print "AP Connected after rebooting"
                         return True
                    print "AP is still rebooting sleeping 30 secs"
                    time.sleep(30)
                else:
                    print "Getting ap status is failed"
                    return False
    ...
    def get_data_plane_info(self,dp_mac=None):
        self.dp_url = "/wsg/api/scg/planes/data/"+dp_mac

        if dp_mac is None:
            print "dp_mac is None"
            return dp_mac

        try:
            url = ji.get_url(self.dp_url, self.scg_mgmt_ip, self.scg_port)
            dp_data = ji.get_json_data(url, self.jsessionid)
            if dp_data["data"]:
                return dp_data["data"]
            return None
        except Exception, e:
    ...
    def reboot_data_plane(self,dp_mac=None, wait=True):

        recvd_data = None
        dp_data = None
        self.json_url = "/wsg/api/scg/planes/data/"+dp_mac+"/reboot"
        ...
        try:
            ...
            sleep_time = 30
            total_sleep_time = 0
            while total_sleep_time < 300:
                dp_data = self.get_data_plane_info(dp_mac=dp_mac)
                if dp_data:
                    if dp_data["status"] == "Running":
                         print "Dataplane Connected after rebooting"
                         return True
                    print "Dataplane is still rebooting sleeping %d secs" % sleep_time
                    time.sleep(sleep_time)
                    total_sleep_time = total_sleep_time + sleep_time
                    print "Total sleep time: %d seconds" % total_sleep_time
                else:
                    print "Getting Dataplane status is failed"
                    #return False
            print "Dataplane not connected after rebooting"
            return False
            ...
            while total_sleep_time < 900:
                ...
                if "data" in validate_data.keys():
                    if validate_data["data"]["previousOperationRecord"]["success"] == True:
                        return True
                print "Backup operation is in progress. Sleeping for %d sec..." % sleep_time
                time.sleep(sleep_time)
                total_sleep_time = total_sleep_time + sleep_time
                print "Total sleep time: %d seconds" % total_sleep_time
            print "Backup operation not completed after %d seconds"  % total_sleep_time
            return False
    ...
    def verify_cluster_is_inservice(self):
        recvd_data = None
        
        try:
            url = ji.get_url(self.system_summary_url, self.scg_mgmt_ip, self.scg_port)
            recvd_data = ji.get_json_data(url, self.jsessionid)
            print recvd_data
            if not recvd_data:
                return None
            if recvd_data["data"]["clusterState"] == "In_Service" and recvd_data["data"]["bladeState"] == "In_Service":
                print "verify_cluster_is_inservice(): Cluster is in service and blade is in service"
                return True
        except Exception, e:
            print traceback.format_exc()
            return None

    def create_web_authentication(self, web_auth_name='Auto_webauth',
                                        apzone_name='APZone',
                                        domain_label='Administration Domain',
                                        description='Auto_webauth',
                                        language='en_US',
                                        second_redirect='user',
                                        start_url=None,
                                        session_timeout='1440',
                                        grace_period='60'):
        result = False
        web_data = {}
        self.create_web_auth_api = '/wsg/api/scg/webAuthentication'
        web_data.update(self.SJT.get_web_auth_template())
        try:
            url = ji.get_url(self.create_web_auth_api, self.scg_mgmt_ip, self.scg_port)
            web_data.update({'name':web_auth_name,
                            'description':description,
                            'language':language,
                            'secondRedirect':second_redirect,
                            'sessionTime':int(session_timeout),
                            'gracePeriod':int(grace_period),
                            'zoneName':apzone_name,
                            'zoneUUID':self.get_apzone_uuid(apzone_name=apzone_name, domain_label=domain_label),
                            'startUrl':start_url,
                            })
    ...
    def _get_webauth_data_and_key(self, web_auth_name='Auto_webauth',
                                    apzone_name='APZone',
                                    domain_label='Administration Domain'):
        key, data = None, None
        is_found = False
        get_api = '/wsg/api/scg/webAuthentication/byZone/%s?'
        zone_uuid = self.get_apzone_uuid(apzone_name=apzone_name, domain_label=domain_label)
        get_data_url = ji.get_url(get_api%zone_uuid, self.scg_mgmt_ip, self.scg_port)
        rcvd_data = ji.get_json_data(get_data_url, self.jsessionid)
        for i in range(0, len(rcvd_data['data']['list'])):
            if rcvd_data['data']['list'][i]['name'] == web_auth_name:
                is_found = True
                key, data = rcvd_data['data']['list'][i]['key'], rcvd_data['data']['list'][i]
                break

        if not is_found:
            print "_get_webauth_data_and_key(): Failed to get key for name %s" % web_auth_name
            return None, None

        return key, data

    def delete_webauth(self, web_auth_name='Auto_webauth',
                             apzone_name='APZone',
                             domain_label='Administration Domain'):
        result = False
        try:
            delete_api = '/wsg/api/scg/webAuthentication/%s'
            key, data = self._get_webauth_data_and_key(web_auth_name=web_auth_name, apzone_name=apzone_name, domain_label=domain_label)
            delete_url = ji.get_url(delete_api % key, self.scg_mgmt_ip, self.scg_port)
            result = ji.delete_scg_data(delete_url, self.jsessionid, None)
        except Exception, e:
            print traceback.format_exc()
            return result
        return result
    ...
    def get_scg_version(self):
        try:
            ...
            if not recvd_data:
                return None
            return recvd_data['data']['version']
        except Exception, e:
            print traceback.format_exc()
            return None
        
    def delete_latest_cluster_backup_file(self, scg_version=None):
        result = False
        try:
            delete_api = '/wsg/api/scg/backup/cluster/%s'
            backup_id = self._get_latest_cluster_backup_id(scg_version=scg_version)
            if not backup_id:
                return None
            delete_url = ji.get_url(delete_api % backup_id, self.scg_mgmt_ip, self.scg_port)
            result = ji.delete_scg_data(delete_url, self.jsessionid, None)
        except Exception, e:
            print traceback.format_exc()
            return result
    ...
    def _get_latest_cluster_backup_id(self,scg_version):
        self.cluster_backup_list_url = "/wsg/api/scg/backup/cluster"
        backup_list = {}
        try:
            url = ji.get_url(self.cluster_backup_list_url, self.scg_mgmt_ip, self.scg_port)
            recvd_data = ji.get_json_data(url, self.jsessionid)

            if not recvd_data:
                return None
            for backup in recvd_data['data']['list']:
                if backup['version']==scg_version:
                    backup_list[backup['createOn']]=backup['backupID']
            if len(backup_list) > 0:
                return backup_list[max(backup_list.keys())]
            else:
                print "No bakup file found"
                return None
        except Exception, e:
            print traceback.format_exc()
            return None

    def create_wispr_profile_in_zone_template(self, wispr_profile_name="Auto_wispr_profile", zone_name="Auto_APZone", domain_label="Administration Domain",
                                   description=None,
                                   #guest_user="0",                                  # "0" or "1"
                                   smart_client_mode="none",                        # enable or none or only
                                   access_type="EXTERNAL",                          # INTERNAL or EXTERNAL
        ...
        try:
            apzone_template_uuid = self.get_apzone_template_uuid(apzone_template_name = apzone_template_name)
            url = ji.get_url(self.req_api_wispr_zone_template%apzone_template_uuid, self.scg_mgmt_ip, self.scg_port)
            wispr_profile.update(self.SJT.get_wispr_template_data())
            
            wispr_profile.update({"name":wispr_profile_name, 
                                  "description":description,
                                  "zoneName":apzone_template_name,
                                  "zoneUUID":apzone_template_uuid})
    ...
    def create_ap_tunnel_profile(self,tunnel_name=None,tunnel_type='RuckusGRE', tunnelMtuSize=None):
        
        try:
            if (tunnel_name==None or tunnel_type==None):
                raise Exception("All fields are mantatory in tinnel creation")
            
            self.req_api_tunnel_profile="/wsg/api/scg/serviceProfiles/aptunnel"
            url = ji.get_url(self.req_api_tunnel_profile, self.scg_mgmt_ip, self.scg_port)
            ...
            sms_data = {"key":"",
                        ...
                        "description":"",
                        "ruckusTunnelModel":1,
                        "tunnelMtuAutoEnabled":1,
                        "tunnelEncryption":0}
            if tunnelMtuSize:
                sms_data.update({"tunnelMtuAutoEnabled":0,
                                 "tunnelMtuSize": tunnelMtuSize})
            data_json = json.dumps(sms_data)
            result = ji.post_json_data(url, self.jsessionid, data_json)
            print result
    ...
    def get_tunnel_profile(self, tunnel_name=None, tunnel_type=None):
        
        try:
            if (tunnel_name==None or tunnel_type==None):
                raise Exception("All fields are mantatory in tinnel creation")
            self.req_api_tunnel_profile="/wsg/api/scg/serviceProfiles/aptunnel?type=%s" % (tunnel_type)
            url = ji.get_url(self.req_api_tunnel_profile, self.scg_mgmt_ip, self.scg_port)
            rcv_data = ji.get_json_data(url, self.jsessionid)
            for i in range(0, len(rcv_data["data"]["list"])):
                if rcv_data["data"]["list"][i]["name"] == tunnel_name:
                    data = rcv_data["data"]["list"][i]
                    break
            return data
        except Exception, e:
            print traceback.format_exc()
    ...
    def delete_tunnel_profile(self, tunnel_name=None, tunnel_type='RuckusGRE'):
        
        try:
            if (tunnel_name==None or tunnel_type==None):
                raise Exception("All fields are mantatory in tinnel creation")
            tunnel_profile=self.get_tunnel_profile(tunnel_name=tunnel_name, tunnel_type=tunnel_type)
            key=tunnel_profile["key"]
            self.req_api_tunnel_profile="/wsg/api/scg/serviceProfiles/aptunnel/%s" % (key)
            url = ji.get_url(self.req_api_tunnel_profile, self.scg_mgmt_ip, self.scg_port)
            delete_profile = {}
            data_json = json.dumps(delete_profile)
            rcv_data = ji.delete_scg_data(url, self.jsessionid,data_json)
            print "Deleted tunnel prrofile [%s]" % (tunnel_name)
    ...
    def create_node_affinity_profile(self, nap_name=None,description="Auto node affinity",affinity_list=None, reverse=None):
        
        try:
            if (nap_name==None):
                raise Exception("Node affinity profile name required")
            
            if not affinity_list: 
                affinity_list = self.get_node_affinity_list()
                
            self.req_api_nap_profile="/wsg/api/scg/nodeaffinity/profile"
            url = ji.get_url(self.req_api_nap_profile, self.scg_mgmt_ip, self.scg_port)
            if reverse:
                affinity_list.reverse()
            nap_data = {"name":nap_name,
                        "description":description,
                        "nodeAffinityList":affinity_list}  
            data_json = json.dumps(nap_data)
            result = ji.post_json_data(url, self.jsessionid, data_json)
            print result    
    ...
    def delete_node_affinity_profile(self, nap_name=None):
        
        try:
            if (nap_name==None):
                raise Exception("Node affinity profile name is required")
            
            key=self.get_node_affinity_profile_id(nap_name=nap_name)
            
            self.req_api_nap_profile="/wsg/api/scg/nodeaffinity/profile/%s" % (key)
            url = ji.get_url(self.req_api_nap_profile, self.scg_mgmt_ip, self.scg_port)
            delete_profile = {}
            data_json = json.dumps(delete_profile)
            rcv_data = ji.delete_scg_data(url, self.jsessionid,data_json)
            print "Deleted node affinity prrofile [%s]" % (nap_name)
            return rcv_data
        except Exception, e:
            print traceback.format_exc()
            return False
    ...
    def get_node_affinity_profile_id(self, nap_name=None):
        try:
            self.req_api_nap_data="/wsg/api/scg/nodeaffinity/profile"
            url = ji.get_url(self.req_api_nap_data, self.scg_mgmt_ip, self.scg_port)
            key=None
            rcv_data = ji.get_json_data(url, self.jsessionid)
            for i in range(0, len(rcv_data["data"]["list"])):
                if rcv_data["data"]["list"][i]["name"] == nap_name:
                    key = rcv_data["data"]["list"][i]["key"]
                    break
            if not key:
                raise Exception("_get_key_for_node_affinity():Key not found for the name:%s" % (nap_name))
            return key
        except Exception, e:
            print traceback.format_exc()
            return False
    ...
    def get_node_affinity_list(self):
        ...
        url = ji.get_url(self.req_api_nap_data, self.scg_mgmt_ip, self.scg_port)
        rcv_data = ji.get_json_data(url, self.jsessionid)
        if(len(rcv_data["data"]["list"])<1):
            raise Exception("No affinity profile found")
        
        return rcv_data["data"]["list"][0]["nodeAffinityList"]
    ...
    def enable_and_disable_node_affinity(self, enable=None, numOfRetries=3, zoneIdToNAPIdMap={}):
        try:
            self.req_api_nap_data="/wsg/api/scg/nodeaffinity"
            gateway_url = ji.get_url(self.req_api_nap_data, self.scg_mgmt_ip, self.scg_port)
            key=None
            data = {
                    "enable":enable,
                    "numOfRetries":numOfRetries,
                    "zoneIdToNAPIdMap":zoneIdToNAPIdMap
            }
    ...
    def update_ntp_server(self,server_ip='pool.ntp.org',timeZone=None):
        result = False
        ntp_data={}
        try:
            url = ji.get_url(self.ntp_server, self.scg_mgmt_ip, self.scg_port)
            ntp_data.update({"ntpServer":server_ip})
            if timeZone:
                ntp_data.update({"timezone":timeZone})
            data = json.dumps(ntp_data)
            result = ji.put_json_data(url, self.jsessionid, data)
        except Exception, e:
            print traceback.format_exc()
            return False
    ...
    def get_arc_app_data(self,radio_id=None,client_mac='E4:A4:71:93:1A:2F'):
        result = False
        arc_app_data={}
        try:
            print "Radio_ID-----------" , radio_id
            url = ji.get_url(self.arc_app, self.scg_mgmt_ip, self.scg_port)
            arc_app_data.update({"extraFilters":[{"type":"RADIOID","value":radio_id}],"attributes":["APPLICATION"],"limit":10,"page":1,"start":0})
            data = json.dumps(arc_app_data)
            result = ji.post_json_data(url, self.jsessionid, data)
        except Exception, e:
            print traceback.format_exc()
            return False
        return result
    
    def get_arc_client_data(self,app_name='google.com',radio_id=None):
        result = False
        arc_client_data={}
        try:
            print "Radio_ID-----------" , radio_id
            url = ji.get_url(self.arc_client, self.scg_mgmt_ip, self.scg_port)
            arc_client_data.update({"extraFilters":[{"type":"RADIOID","value":radio_id},
                                  {"type":"APP","value":app_name}],"limit":10,"page":1,"start":0})
            data = json.dumps(arc_client_data)
            result = ji.post_json_data(url, self.jsessionid, data)
        except Exception, e:
            print traceback.format_exc()
            return False
...
#     import ScgJsonConfig as sjc

#     sj = sjc.ScgJsonConfig(scg_mgmt_ip="172.19.16.170", scg_port="8443")
#     sj._login(username='admin', password='ruckus1!') 
#     list= sj.get_node_affinity_list()
#     #sj.create_node_affinity_profile(nap_name="test12",description="Auto node affinity",affinity_list=list)
#     sj.delete_node_affinity_profile(nap_name="test12")
